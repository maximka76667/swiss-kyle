...
- [[wiki/issues/e2e-ci-session-creation-timeout]] — Linux resolved (tauri-driver launched before any display existed); Windows dropped from e2e CI as won't-fix after three unrelated fixes all failed identically
