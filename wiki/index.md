...
- [[wiki/issues/e2e-ci-session-creation-timeout]] — Linux resolved (tauri-driver launched before any display existed); Windows still open — initial mismatched-driver diagnosis disproven, real cause unknown, app-log capture added to find it
